...
const TENANT_CONFIGS: Record<string, TenantConfig> = {
  'bjp-tn': { slug: 'bjp-tn', name: 'BJP Tamil Nadu', port: 5175 },
  'bjp-up': { slug: 'bjp-up', name: 'BJP Uttar Pradesh', port: 5176 },
  'aidmk-tn': { slug: 'aidmk-tn', name: 'AIDMK Tamil Nadu', port: 5177 },
};
